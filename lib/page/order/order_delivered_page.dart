                        ...
                        return SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              ...orders.map((o) => _DeliveredOrderCard(order: o)),
                            ],
                          ),
                        );
                      },
...
/// Card chỉ dùng cho trang DELIVERED
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    const Expanded(
                      child: Center(child: Text('Xem thêm >>', style: TextStyle(color: Colors.white70))),
                    ),
                    Row(
                      children: [
                        const Text('Tổng: ', style: TextStyle(color: Colors.white70)),
                        Text(_fmtVnd(order.totalPrice),
